...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="Center_Container">
        <div class="Center_Container_Content">
            ...
            <asp:TextBox ID="txtID" runat="server" placeholder="아이디를 입력하십시오." ValidationGroup="IDCheck" Width="200px" />
            <asp:TextBox ID="TextBox2" runat="server" ValidationGroup="NewUser" Text="Ready" Enabled="false" Width="60px" /><br />
            ...
            <asp:TextBox ID="txtPassword" runat="server" TextMode="Password" placeholder="암호를 입력하십시오." ValidationGroup="NewUser" Width="200px"></asp:TextBox><br />
            
            <asp:Label ID="label10" runat="server" Text ="확인"></asp:Label><br />
            <asp:TextBox ID="txtReCheck" runat="server" TextMode="Password" placeholder="암호를 재입력 하십시오." ValidationGroup="NewUser" Width="200px"></asp:TextBox>
            ...
            <asp:TextBox ID="txtName" runat="server" ValidationGroup="NewUser" Width="200px"></asp:TextBox><br />
            ...
            <asp:TextBox ID="TextBox1" runat="server" TextMode="Date" Width="200px"></asp:TextBox><br />

            <asp:Label ID="label4" runat="server" Text="주소"></asp:Label><br />
            <asp:TextBox ID="txtAddress" runat="server" ValidationGroup="NewUser" Width="200px"></asp:TextBox><br />

            <asp:Label ID="label5" runat="server" Text="상세주소"></asp:Label><br />
            <asp:TextBox ID="txtAddress2" runat="server" Width="200px"></asp:TextBox><br />

            <asp:Label ID="label7" runat="server" Text="비고"></asp:Label><br />
            <asp:TextBox ID="txtMemo" runat="server" TextMode="MultiLine" Columns="23" Rows="8"></asp:TextBox><br />
