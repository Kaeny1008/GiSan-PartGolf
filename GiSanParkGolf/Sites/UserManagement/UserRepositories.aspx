...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="Center_Container">
        <div class="Center_Container.Content">
            ...
            <asp:TextBox ID="txtID" runat="server" placeholder="아이디를 입력하십시오." ValidationGroup="IDCheck" Width="360px"></asp:TextBox>
            <asp:TextBox ID="TextBox2" runat="server" ValidationGroup="NewUser" Text="Ready" Enabled="false" Width="60px"></asp:TextBox>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                ...
                Display="None" ForeColor="red" ValidationGroup="NewUser"></asp:RequiredFieldValidator><br />
            ...
            <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" 
                ...
                ErrorMessage="비밀번호는 반드시 4~12자리의 공백 없는 문자로 이루어져야 합니다." Display="None" ForeColor="red" ValidationGroup="NewUser"></asp:RegularExpressionValidator>
            ...
            <asp:CompareValidator ID="CompareValidator1" runat="server" 
                ...
                ErrorMessage="비밀번호가 일치하지 않습니다." Display="None" ForeColor="red" ValidationGroup="NewUser"></asp:CompareValidator><br />
