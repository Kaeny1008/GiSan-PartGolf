...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function ValidateCheck() {
            ...
            console.log("체크 완료? : " + isValid);

            if (isValid) {
                console.log("유효성 통과 → 저장 확인 모달 띄움");
                ShowModal(); // 기존 저장 처리 모달
            } else {
                console.log("유효성 실패 → 오류 안내 모달 띄움");
    ...
    <div class="mb-3 text-center">
        <h4 class="fw-bold mb-2" id="MainTitle" runat="server">사용자 정보수정</h4>
